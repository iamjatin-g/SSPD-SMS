  ...
  final List<Map<String, String>> inboxMessages = [
    {
      ...
      "body": "Solve 10 questions",
      "date": "15 Feb, Sat",
    },
    {
      "subject": "Science Project",
      "body": "Prepare for model making",
      "date": "14 Feb, Fri",
    },
    {
      "subject": "English Essay",
      "body": "Write an essay on nature",
      "date": "13 Feb, Thu",
    },
    {
      "subject": "History Notes",
      "body": "Complete chapter 5 notes",
      "date": "12 Feb, Wed",
    },
  ];
  ...
  final List<Map<String, String>> sentMessages = [
    {
      ...
      "body": "Absent on 16th Feb",
      "date": "15 Feb, Sat",
    },
    {
      "subject": "Project Submission",
      "body": "Submitted my assignment",
      "date": "14 Feb, Fri",
    },
  ];
